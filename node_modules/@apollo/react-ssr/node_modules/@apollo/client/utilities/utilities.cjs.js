...
function relayStylePagination(keyArgs) {
    ...
    return {
        ...
        merge: function (existing, incoming, _a) {
            ...
            var wrappers = tslib.__spreadArrays(prefix, incomingWrappers, suffix);
            var firstWrapper = wrappers[0];
            var lastWrapper = wrappers[wrappers.length - 1];
            var pageInfo = tslib.__assign(tslib.__assign(tslib.__assign({}, incoming.pageInfo), existing.pageInfo), { startCursor: firstWrapper && firstWrapper.cursor || "", endCursor: lastWrapper && lastWrapper.cursor || "" });
            if (incoming.pageInfo) {
            ...
            return tslib.__assign(tslib.__assign(tslib.__assign({}, getExtras(existing)), getExtras(incoming)), { wrappers: wrappers,
                pageInfo: pageInfo });
        },
    };
}
